<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewCompetitor.aspx.cs" Inherits="WRT.Client._NewCompetitor" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div style="text-align: center">
             <asp:Button runat="server" ID="btnToRace" Text="Spara" Width="250px" OnClick="BtnToRace_OnClick" /><br />
