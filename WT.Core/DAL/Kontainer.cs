...
namespace IPS.Core.DAL
{
    public class Kontainer : DALBase
    {
        public static List<BLL.Kontainer> Hämta(int? kontainerId)
        {
            DataTable dt;
        ...
        private static BLL.Kontainer PopulateObject(DataRow dr)
        {
            var pos = new BLL.Kontainer
                {
